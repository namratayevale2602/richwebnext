              ...
              {branches.map((branch, index) => (
                <div key={index} className="mb-4 last:mb-0">
                  ...
                  <div className="grid grid-cols-2 gap-2 ml-6">
                    {/* WhatsApp Button */}
                    <a
                      href={`https://wa.me/${branch.whatsapp.replace(/\+/g, '')}?text=${encodeURIComponent("Hello, I would like to know more about your services")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center bg-green-500 hover:bg-green-600 text-white px-2 py-2 rounded transition-colors text-sm"
                    >
